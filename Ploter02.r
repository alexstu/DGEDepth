...
plotsamExplorer(ER_df, save = TRUE, p.depth = 0.9, filename = paste('PR_ER_fold_',filter, sep = ''),anova = FALSE,y.lab="Precision", leg.name = 'Methods', title = paste('Precision for ER+ data, ',xxxx, 'fold filtering',sep=''))
plotsamExplorer(TNBC_df, save = TRUE, p.depth = 0.9, filename = paste('PR_TNBC_fold_',filter, sep = ''),anova = FALSE,y.lab="Precision", leg.name = 'Methods', title = paste('Precision for TNBC data, ',xxxx, 'fold filtering',sep=''))
