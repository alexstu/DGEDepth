...
plotsamExplorer(ER_df, save = TRUE, p.depth = 0.9, filename = paste('sub_ER_fold_',filter, sep = ''),y.lab="Number of DEGs", leg.name = 'Methods', title = paste('DE genes for (5+5) samples of ER+ data, ',xxxx, 'fold filtering',sep=''), x.lab = 'Data used in the analysis (f)', leg.pos = 'bottom', anova=F)
plotsamExplorer(TNBC_df, save = TRUE, p.depth = 0.9, filename = paste('sub_TNBC_fold_',filter, sep = ''),y.lab="Number of DEGs", leg.name = 'Methods', title = paste('DE genes for (5+5) samples of TNBC data, ',xxxx, 'fold filtering',sep=''), x.lab = 'Data used in the analysis (f)', leg.pos = 'bottom', anova=F)
