...
load('Scripts/-1/JKde_ER_ebseq_0.05_2')
load('Scripts/-1/JKde_TNBC_ebseq_0.05_2')
...
save('go_ER_ebseq', file = paste('go_ER_ebseq_',as.character(pval), '_', as.character(fold), sep = ''))
save('go_TNBC_ebseq', file = paste('go_TNBC_ebseq_',as.character(pval), '_', as.character(fold), sep = ''))
