...
save('de_ER_ebseq', file = 'sub_JKde_ER_ebseq_0.05_none')

de_TNBC_ebseq <- TNBC_list_de_all
save('de_TNBC_ebseq', file = 'sub_JKde_TNBC_ebseq_0.05_none')

de_ER_ebseq <- ER_list_de_fold
save('de_ER_ebseq', file = 'sub_JKde_ER_ebseq_0.05_2')

de_TNBC_ebseq <- TNBC_list_de_fold
save('de_TNBC_ebseq', file = 'sub_JKde_TNBC_ebseq_0.05_2')
