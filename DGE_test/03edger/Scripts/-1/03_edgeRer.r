...
save('de_ER_edger', file = paste('JK_de_ER_edger_',as.character(pval), '_', as.character(fold), sep = ''))
save('de_TNBC_edger', file = paste('JK_de_TNBC_edger_',as.character(pval), '_', as.character(fold), sep = ''))
