...
plotsamExplorer(ER_df, save = TRUE, p.depth = 0.9, filename = paste('sub_FDR_ER_fold_',filter, sep = ''),y.lab="FDR", leg.name = 'Methods', title = paste('FDR for ER+ data, ',xxxx, 'fold filtering',sep=''), x.lab = 'Data used in the analysis (f)', leg.pos = 'bottom', anova=F)
plotsamExplorer(TNBC_df, save = TRUE, p.depth = 0.9, filename = paste('sub_FDR_TNBC_fold_',filter, sep = ''),y.lab="FDR", leg.name = 'Methods', title = paste('FDR for TNBC data, ',xxxx, 'fold filtering',sep=''), x.lab = 'Data used in the analysis (f)', leg.pos = 'bottom', anova=F)
